...
class ERDExport(Job):
    """Export the Nautobot schema as a Lucidchart-compatible CSV. Includes Custom Fields and Relationships."""

    class Meta:
        """Job metadata."""

        name = "Export ERD (Lucidchart)"
        description = "Exports the Nautobot database schema, including Custom Fields and Relationships for Lucidchart."
    ...
    def run(self):
        ...
        self.logger.success("Successfully created '%s' containing %d records.", filename, len(rows))
